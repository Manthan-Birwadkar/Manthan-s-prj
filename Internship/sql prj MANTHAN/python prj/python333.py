...
base_url = "https://www.timesjobs.com/candidate/job-search.html?searchType=Home_Search&from=submit&asKey=OFF&txtKeywords=&cboPresFuncArea=42"
results_per_page = 24
total_results_to_fetch = 1326
...
jobs_df.to_excel('data scraping jobdata link 3.xlsx', index=False)